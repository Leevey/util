...
public class PageUtil {
	 ...
	 * @param currentPageRecordnum 当前页有多少记录
	 * @return String
	 */
	public static String getAjaxPageHtml(String functionName,int currentPage,int pageCount,int recordCount,int currentPageRecordnum){
		StringBuffer output = new StringBuffer();
		output.append("<table class="+tableClassName+" align=center width=100% cellspacing=0 cellpadding=0 >\n");
		output.append("<tr>\n");
		output.append("<td align=center >本页"+currentPageRecordnum+"条/共" + recordCount+ "条</td>\n");
		if (currentPage <= 1) {
